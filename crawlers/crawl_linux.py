...
def crawl_msg():
    url_dic = {
        ...
        "xiaomuchong": ["http://muchong.com/bbs/kaoyan.php?action=adjust&type=1","http://muchong.com/bbs/kaoyan.php?action=adjust&type=1&page=1&page=2","http://muchong.com/bbs/kaoyan.php?action=adjust&type=1&page=1&page=3","http://muchong.com/bbs/kaoyan.php?action=adjust&type=1&page=3&page=4"]
    }
    headers = {
